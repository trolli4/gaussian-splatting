...
class GaussianModel:
    ...
    def densify_and_clone(self, errors, error_threshold, scene_extent):
        ...
        new_opacities = 1 - torch.sqrt(1 - self._opacity[selected_pts_mask])                            # equation from local revising densification paper: 
        self._opacity[selected_pts_mask] = 1 - torch.sqrt(1 - self._opacity[selected_pts_mask])         # alpha_new = 1 - sqrt(1 - alpha)
